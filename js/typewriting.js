...
description_typewriter.typeString('Hello World!')
    ...
    .typeString("I'm Student of BCA,Padmakanya campus.")
    .pauseFor(1500)
    .deleteChars(22)

    .typeString("<strong> websites </strong> & <strong> Andriods UI designs💡.</strong>")
    .pauseFor(1500)
    .deleteChars(50)
    ...
    .typeString("An Author <strong> Towards tech websites </strong>.")
    .pauseFor(1500)
    .deleteChars(40)
    .deleteAll()
    .start();
...
// var about_main_text = "Kritika Dhakal is a Data Scientist at IUDX Programme Unit, Society of Innovation and Technology(SID), IISc Banglore, where he is working on the Research & Development for building data exchange platform for smart cities. kritika has recently received his Bachelor's degree in Computer Science from the Indian Institute of Information Technology. At Kaggle, kritika has achieved a Master tier with 2 gold and 12 silver medals with the highest world ranking as 186 out of 138,000+ data scientists. He also loves writing and his works are published Towards Data Science(TDS). Apart from that, he also helps junior coders develop programming skills through an online collaborative-based classroom environment. Not only the tech stuff, paras love to play guitar and drums and also do speedcubing. He has represented in state-level Table Tennis in UP and played a few zonals. Kritika loves traveling and exploring new things."
